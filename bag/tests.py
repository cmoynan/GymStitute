...
class BagViewsTest(TestCase):
    ...
    def test_add_to_bag_without_size(self):
        ...
        self.assertIn('test_item', bag)  # Check item is added
        self.assertEqual(bag['test_item'], 2)  # Check correct quantity added
        messages = list(response.wsgi_request._messages)
        self.assertTrue(any('2 of the product added to your bag!' in str(message) for message in messages))
    ...
    def test_add_to_bag_with_size(self):
        ...
        messages = list(response.wsgi_request._messages)
        self.assertTrue(any('1 x M added to your bag!' in str(message) for message in messages))
    ...
    def test_remove_from_bag(self):
        ...
        messages = list(response.wsgi_request._messages)
        self.assertTrue(any('Item successfully removed from your bag!' in str(message) for message in messages))
    ...
    def test_remove_nonexistent_item(self):
        ...
        self.assertEqual(response.status_code, 302)
        messages = list(response.wsgi_request._messages)
        self.assertTrue(any('Item not found in your bag.' in str(message) for message in messages))
